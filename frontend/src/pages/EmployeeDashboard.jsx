...
const s = {
  ...
  summaryItem: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.1rem 1rem', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)', transition: 'all 0.15s ease' },
  summaryVal: { display: 'block', fontSize: '28px', fontWeight: '700', color: '#0f172a', lineHeight: '1.3' },
  summaryLabel: { fontSize: '11px', color: '#64748b', marginTop: '4px', fontWeight: '500', textTransform: 'uppercase', letterSpacing: '0.5px' },
  sectionTitle: { fontSize: '18px', fontWeight: '700', marginBottom: '1rem', color: '#0f172a', letterSpacing: '-0.2px', lineHeight: '1.3' },
  goalCard: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.25rem 1.5rem', marginBottom: '0.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)', transition: 'all 0.15s ease', borderLeft: '3px solid #e2e8f0' },
  ...
  goalMeta: { fontSize: '13px', color: '#64748b', marginBottom: '2px', lineHeight: '1.5' },
  ...
  progressBg: { height: '8px', background: '#e2e8f0', borderRadius: '4px', overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: '4px', transition: 'width 0.6s cubic-bezier(0.4,0,0.2,1)' },
  formCard: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', marginBottom: '0.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)' },
  formCardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', paddingBottom: '0.75rem', borderBottom: '1px solid #f1f5f9' },
  grid2: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  field: { marginBottom: '0.85rem' },
  label: { display: 'block', fontSize: '11px', fontWeight: '600', marginBottom: '6px', color: '#64748b', letterSpacing: '0.5px', textTransform: 'uppercase' },
  input: { width: '100%', padding: '9px 12px', border: '1px solid #e2e8f0', borderRadius: '8px', fontSize: '14px', boxSizing: 'border-box', color: '#0f172a', transition: 'all 0.15s ease', outline: 'none', background: '#fff' },
  weightageBar: { padding: '1rem 1.25rem', borderRadius: '10px', marginBottom: '1.25rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  btnPrimary: { padding: '10px 20px', background: 'linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '14px', boxShadow: '0 2px 8px rgba(37,99,235,0.25)', transition: 'all 0.15s ease', letterSpacing: '0.2px' },
  btnSecondary: { padding: '10px 20px', background: '#fff', color: '#374151', border: '1px solid #e2e8f0', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', fontWeight: '500', transition: 'all 0.15s ease' },
  btnCheckin: { padding: '6px 14px', background: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '12px', fontWeight: '600', boxShadow: '0 2px 6px rgba(124,58,237,0.25)', transition: 'all 0.15s ease' },
  btnDanger: { padding: '5px 12px', background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '500', transition: 'all 0.15s ease' },
  btnAI: { marginTop: '8px', padding: '8px 16px', background: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '12px', fontWeight: '600', display: 'inline-flex', alignItems: 'center', gap: '6px', boxShadow: '0 2px 8px rgba(124,58,237,0.25)', transition: 'all 0.15s ease' },
  suggestionChip: { padding: '10px 14px', background: '#faf5ff', border: '1px solid #e9d5ff', borderRadius: '8px', fontSize: '13px', cursor: 'pointer', color: '#6d28d9', marginBottom: '6px', lineHeight: '1.5', transition: 'all 0.15s ease', fontWeight: '500' },
  infoBox: { background: '#eff6ff', color: '#1d4ed8', padding: '0.85rem 1.25rem', borderRadius: '10px', marginTop: '0.75rem', fontSize: '14px', border: '1px solid #bfdbfe', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '8px' },
  empty: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '3.5rem 2rem', textAlign: 'center', color: '#64748b', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' },
}
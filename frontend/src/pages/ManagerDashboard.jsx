...
const s = {
  ...
  memberCard: { background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.25rem 1.5rem', marginBottom: '0.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', transition: 'all 0.15s ease', boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)' },
  ...
  memberName: { fontSize: '15px', fontWeight: '600', color: '#0f172a', lineHeight: '1.4' },
  memberMeta: { fontSize: '13px', color: '#64748b' },
  memberArrow: { fontSize: '18px', color: '#94a3b8', marginLeft: '12px', transition: 'transform 0.15s ease' },
  ...
  badge: { fontSize: '12px', fontWeight: '600', padding: '4px 12px', borderRadius: '20px', whiteSpace: 'nowrap', letterSpacing: '0.2px' },
  editBox: { marginTop: '14px', padding: '1.25rem', background: '#f8fafc', borderRadius: '10px', border: '1px solid #e2e8f0' },
  ...
  btnApprove: { padding: '8px 16px', background: '#f0fdf4', color: '#16a34a', border: '1px solid #bbf7d0', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '13px', transition: 'all 0.15s ease', display: 'inline-flex', alignItems: 'center', gap: '4px' },
  btnEdit: { padding: '8px 16px', background: '#fffbeb', color: '#b45309', border: '1px solid #fde68a', borderRadius: '8px', cursor: 'pointer', fontSize: '13px', fontWeight: '600', transition: 'all 0.15s ease', display: 'inline-flex', alignItems: 'center', gap: '4px' },
  btnReject: { padding: '8px 16px', background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca', borderRadius: '8px', cursor: 'pointer', fontSize: '13px', fontWeight: '600', transition: 'all 0.15s ease', display: 'inline-flex', alignItems: 'center', gap: '4px' },
